package com.tx.demo.common.develop.support;
...
import com.tx.demo.common.develop.constant.DevelopConstant;
import com.tx.demo.common.utils.Func;
import com.tx.demo.common.utils.StringUtil;
import lombok.Data;
...
public class CodeGenerator {
	...
	private InjectionConfig getInjectionConfig() {
		...
		if (Func.equals(systemName, DevelopConstant.LEMON_NAME)) {
		...
		if (Func.isNotBlank(packageWebDir)) {
			if (Func.equals(systemName, DevelopConstant.SWORD_NAME)) {
			...
			} else if (Func.equals(systemName, DevelopConstant.LEMON_NAME)) {
				focList.add(new FileOutConfig("/templates/lemon/data.ts.vm") {
					@Override
					public String outputFile(TableInfo tableInfo) {
						return getOutputWebDir() + "/api" + "/" + servicePackage.toLowerCase() + "/" + tableInfo.getEntityName().toLowerCase() + ".ts";
					}
				});
				focList.add(new FileOutConfig("/templates/lemon/data.data.ts.vm") {
					@Override
					public String outputFile(TableInfo tableInfo) {
						return getOutputWebDir() + "/views" + "/" + servicePackage.toLowerCase() + "/" + tableInfo.getEntityName().toLowerCase() + "/" + tableInfo.getEntityName().toLowerCase() + ".data.ts";
					}
				});
				...
				focList.add(new FileOutConfig("/templates/lemon/Modal.vue.vm") {
					@Override
					public String outputFile(TableInfo tableInfo) {
						return getOutputWebDir() + "/views" + "/" + servicePackage.toLowerCase() + "/" + tableInfo.getEntityName().toLowerCase() + "/" + tableInfo.getEntityName() + "Modal.vue";
					}
				});
			}
		}
