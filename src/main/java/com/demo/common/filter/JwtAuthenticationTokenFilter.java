...
import com.demo.common.jwt.JwtSecurityProperties;
import com.demo.common.jwt.JwtTokenUtils;
import com.demo.common.utils.SpringUtil;
...
public class JwtAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
        JwtSecurityProperties jwtSecurityProperties = SpringUtil.getBean(JwtSecurityProperties.class);
